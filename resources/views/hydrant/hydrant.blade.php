                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-right">
                                <a href="/hydrant/create" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add
                                    Hydrant</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('hydrant.destroy', $data->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
